// service-worker.js
// Cache strategy:
//   - Static shell: cache-first, versioned cache
...
const SHELL_CACHE = "startpage-shell-v2";
const DYNAMIC_CACHE = "startpage-dynamic-v2";
...
self.addEventListener("fetch", (event) => {
  ...
  // JS/CSS modules — prefer fresh code and fall back to cache offline.
